...
interface IJobsiteMonthNonCostedMaterialReports {
  dayReports: JobsiteDayReportFullSnippetFragment[];
  crewType: CrewTypes;
}

const JobsiteMonthNonCostedMaterialReports = ({
  dayReports,
  crewType,
}: IJobsiteMonthNonCostedMaterialReports) => {
  /**
   * ----- Variables -----
   */
...
export default JobsiteMonthNonCostedMaterialReports;
